                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><label class="text-black-50 font-weight-bold badge badge-success">TRABAJANDO</label></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">OR-00001</th>
                                                <td>10/10/2021</td>
                                                ...
                                                <td>Francisco Torres Flores</td>
                                                <td class="text-center"><button type="button" class="btn btn-outline btn-rounded btn-icon" data-bs-toggle="modal" data-bs-target="#modalAgregar"><i class="mdi mdi-library-books mdi-18px text-info"></i></button></td>
                                                <td class="text-center"><label class="text-black-50 font-weight-bold badge badge-warning">PENDIENTE</label></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">OR-00001</th>
                                                <td>10/10/2021</td>
