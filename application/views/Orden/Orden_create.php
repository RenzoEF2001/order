                                            ...
                                            <div class="row">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <i data-toggle="tooltip"
                                                        class="mdi mdi-information-outline text-secondary"
                                                        title="Solo apareceran los clientes con sucursales"></i>
                                                </div>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="actualizarDetalleOrdenCreate" type="button" class="btn btn-primary"
                    hidden>Actualizar</button>
            </div>
        </div>
    </div>
</div>