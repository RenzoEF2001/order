                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="ID_USUARIO" hidden
                                                value="<?=$usuario[0]["ID_USUARIO"]?>" class="form-control"
                                                placeholder="2019283828" />
                                            <input type="number" name="COD_USUARIO"
                                                value="<?=$usuario[0]["COD_USUARIO"]?>" class="form-control" disable />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="password" name="CONTRASEÑA"
                                                value="<?=$usuario[0]["CONTRASEÑA"]?>" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" REQUIRED name="FOTO" value="<?=$usuario[0]["FOTO"]?>"
