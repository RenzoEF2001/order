            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <center><h2>Administración de tipo de sistemas</h2></center>
                            <div class="dvbusq">

                                <input type="text" name="" id="" class="form-control" placeholder="Buscar..." style="width: 50%;">

                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" href="#" data-bs-target="#exampleModal" >Agregar +</button>
                            </div>
                            <div class="card tablescroll">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><a href="../Dispositivo/Dispositivo_edit.html"><i class="fi fi-rr-edit"></i></a></td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar tipo de sistema</h5>
                </div>
