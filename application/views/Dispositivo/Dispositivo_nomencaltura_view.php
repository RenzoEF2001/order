        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-12">
                        <center><h2>Administración de nomenclaturas</h2></center>
                        <form action="">
                            <div class="dvbusq">
                            
                                <input type="text" name="" id="" class="form-control" placeholder="Buscar..." style="width: 50%;">

                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" href="#" data-bs-target="#exampleModal2" href="">Agregar +</button>
                            </div>
                    </form>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Agregar nomenclatura</h5>
        </div>
