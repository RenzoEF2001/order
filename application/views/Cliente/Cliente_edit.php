                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?= validation_errors('<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                            ...
                            ?>
                        <form class="form-sample"  action="<?php echo site_url('Cliente/EditCli') ?>" method="post">
                            
                            <p class="card-description">Modificar informacion del cliente</p>
                            <input name="COD_CLIENTE" hidden value="<?=$clientes[0]["COD_CLIENTE"]?>"
