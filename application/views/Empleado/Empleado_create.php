                        ...
                        <form class="form-sample" method="post" action="<?= site_url('empleado/save') ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" accept=".jpg,.jpeg,.png" name="imagen"
                                                    id="txtImagenEmpleado" class="file-upload-default" multiple>
                                                <div class="input-group col-xs-12">
                                                    <input type="text" id="txtImagenNombreEmpleado"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="input-group">
                                                    <input id="txtImagenEmpleado" type="text"
                                                        class="form-control file-upload-info" disabled=""
                                                        placeholder="Upload Image">
                                                    <div class="d-flex align-items-center pl-1 pr-0">
                                                        <button id="txtImagenNombreEmpleado"
                            ...
                            <div class="form-group mt-5 mb-0">
                                <div class="row justify-content-end">
                                    ...
                                    <div id="btnAtrasEmpleado" hidden>
                                        <button type="button"
                                            class="btn btn-gradient-primary btn-icon-text d-flex align-items-center mr-2">
