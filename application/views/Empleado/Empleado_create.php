                            ...
                            <div class="card-body" >
                                ...
                                <form class="form-sample">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control"REQUIRED placeholder="" type="number" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" REQUIREDplaceholder="" type="password" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div style="display: flex;align-items:center;justify-content: flex-end; margin-left: 10px;">       
                                        <button id="btnCrear" type="submit" class="btn btn-dark btn-fw" style="display: flex;"><i class="fi fi-rr-disk" style="display: flex;margin-right: 10px;"></i>Crear </button>
                                        <div style="margin-left: 10px;">
                                            <button id="btnContinuar" type="button" class="btn btn-dark btn-fw" style="display: flex;" >Continuar <i class="mdi mdi-arrow-right" style="display: flex;margin-right: 0px;"></i></button>
                                            <button id="btnAtras" type="button" class="btn btn-dark btn-fw" style="display: flex;" hidden><i class="mdi mdi-arrow-left" style="display: flex;margin-right: 0px;"></i>Atras</button>
                                        </div>
                                    </div>
